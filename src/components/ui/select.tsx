    ...
    <S.Root value={value} onValueChange={onValueChange} disabled={disabled}>
      ...
      <S.Portal>
        <S.Content
          position="popper"
          sideOffset={4}
          className="z-[var(--z-index-popover)] max-h-[min(var(--radix-select-content-available-height),22rem)] min-w-[var(--radix-select-trigger-width)] overflow-hidden rounded-md border border-border-popover bg-popover shadow-popover"
        >
