    ...
    <div className="flex flex-col gap-2">
      <Popover open={open} onOpenChange={setOpen}>
        <PopoverTrigger
          id={id}
          aria-describedby={describedBy}
          className="flex h-[var(--control-h-md)] w-full items-center justify-between gap-2 rounded-md border border-border-strong bg-input px-3 text-left text-sm hover:border-fg-tertiary focus-visible:border-focus focus-visible:outline-2 focus-visible:outline-offset-0 focus-visible:outline-focus/40"
        >
