  ...
  return [
    {
      ...
      frequency: "daily",
      owner: "u_sari",
      dataset: "Permintaan harian · 2 tahun · 48 lokasi",
      features: ["Permintaan tertunda (7/14/28 hari)", "Hari dalam minggu", "Hari libur nasional", "Kalender promosi", "Indeks harga", "Grup toko"],
      limitations: [
        "Akurasi menurun untuk SKU dengan riwayat kurang dari 60 hari.",
        "Promosi yang belum ada di kalender promosi tidak diperhitungkan.",
        "Rentang dikalibrasi pada tingkat SKU; rentang agregat bersifat perkiraan.",
      ],
    ...
    },
    {
      ...
      frequency: "daily",
      owner: "u_sari",
      dataset: "Permintaan harian · 2 tahun · 48 lokasi · indeks cuaca",
      features: ["Permintaan tertunda (7/14/28 hari)", "Hari dalam minggu", "Hari libur nasional", "Kalender promosi", "Indeks harga", "Grup toko", "Indeks cuaca wilayah"],
      limitations: [
        "Cakupan indeks cuaca belum lengkap untuk lokasi di Sulawesi.",
        "Belum divalidasi untuk rentang di atas 60 hari.",
      ],
    ...
    },
    {
      ...
      frequency: "daily",
      owner: "u_lina",
      dataset: "Permintaan harian · 1 tahun · per SKU-lokasi",
      features: ["Level", "Tren", "Musiman mingguan"],
      limitations: ["Tidak memakai data promosi atau harga.", "Dipakai sebagai cadangan bila model global tidak tersedia."],
    ...
    },
    {
      ...
      frequency: "weekly",
      owner: "u_sari",
      dataset: "Permintaan mingguan · hanya produk lambat laku",
      features: ["Ukuran permintaan", "Jarak antar-permintaan"],
      limitations: ["Hanya cocok untuk SKU lambat laku (kurang dari 3 penjualan per minggu)."],
      metrics: { ...metrics(0.408, 0.044, 0.83, 3.1), population: "412 SKU lambat laku, granularitas mingguan" },
    ...
    },
    {
      ...
      owner: "u_sari",
      dataset: "Permintaan harian · 2 tahun · 48 lokasi",
      features: ["Permintaan tertunda (7/14/28 hari)", "Hari dalam minggu", "Hari libur nasional", "Kalender promosi"],
      limitations: ["Sudah digantikan versi 2.4."],
