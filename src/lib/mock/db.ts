  ...
  db.sources = [
    {
      ...
      description: "Point-of-sale sales lines aggregated to SKU × store × day.",
    },
    {
      id: "src_erp",
      ...
      description: "Wholesale and B2B orders from the ERP, used for non-POS demand.",
    },
    {
      id: "src_dwh",
      ...
      description: "Product and store master data, hierarchy and attributes.",
    },
    {
      id: "src_promo",
      ...
      description: "Planned promotions and mechanics, used as a model feature.",
    },
    {
      id: "src_upload",
      ...
      description: "Manual CSV of new SKUs and their analogue products.",
    },
  ];
}
  ...
  db.dqIssues = [
    {
      ...
      severity: "blocking",
      sourceId: "src_pos",
      title: "Missing daily demand for 12 SKUs",
      description: "No POS records were received for 12 SKUs at 3 Sulawesi stores between 9 and 3 days ago.",
      affectedSkus: 12,
      affectedLocations: 3,
    ...
    },
    {
      ...
      severity: "warning",
      sourceId: "src_promo",
      title: "Promotions calendar has not updated for 4 days",
      description: "The last successful sync of the promotions calendar was 4 days ago. The latest attempt failed with HTTP 401.",
    ...
    },
    {
      ...
      severity: "warning",
      sourceId: "src_erp",
      title: "Duplicate order lines in ERP extract",
      description: "214 order lines appear twice in the ERP extract with identical order number, SKU and quantity.",
      affectedSkus: 57,
      affectedLocations: 6,
    ...
    },
    {
      ...
      severity: "warning",
      sourceId: "src_pos",
      title: "Unexpected zero demand for high-volume SKUs",
      description: "9 SKUs that normally sell more than 200 units a day recorded zero sales yesterday.",
      affectedSkus: 9,
    ...
    },
    {
      ...
      severity: "info",
      sourceId: "src_pos",
      title: "Extreme sales spike for 3 SKUs",
      description: "3 SKUs sold more than 8× their 28-day average on a single day.",
      affectedSkus: 3,
      affectedLocations: 2,
    ...
    },
    {
      ...
      severity: "warning",
      sourceId: "src_erp",
      title: "Order lines reference unknown SKUs",
      description: "38 order lines reference SKUs that are not in the product master.",
      affectedSkus: 38,
      affectedLocations: 4,
    ...
    },
    {
      ...
      severity: "info",
      sourceId: "src_dwh",
      title: "New column in store dimension",
      description: "The store dimension now includes a column `store_format_v2` that is not mapped.",
      affectedSkus: 0,
      affectedLocations: 0,
  ...
  db.overrides = [
    {
      ...
      evidence: "Supplier allocation letter, reference ALC-0921.",
      comment: "Supplier allocation reduced for 4 weeks.",
      userId: "u_arif",
      createdAt: iso(now - 3 * HOUR_MS),
      status: "applied",
      approvalId: null,
    },
    {
      ...
      evidence: "Trade promotion brief TPB-1142 (buy 2 get 1, weeks 1–2).",
      comment: "Promotion was agreed after the promotions calendar stopped syncing.",
      userId: "u_rina",
...
function seedApprovals(db: WorkspaceDb, now: number) {
  ...
  if (ovr) {
    approvals.push({
      ...
      impact: {
        ...
        summary: "Raises the planning baseline for promoted beverages over the next 4 weeks.",
      },
      changeSet: [{ field: "Forecast (28 days)", from: `${ovr.originalUnits.toLocaleString("en-US")} units`, to: `${ovr.newUnits.toLocaleString("en-US")} units` }],
  ...
  if (holiday && holiday.result) {
    approvals.push({
      ...
      impact: {
        ...
        skuCount: db.products.length,
        summary: "Adopting this scenario replaces the baseline for the affected categories in the next plan.",
      },
  ...
  approvals.push({
    ...
    impact: {
      ...
      summary: "Publishing sends planned quantities to replenishment for the next 4 weeks.",
    },
  ...
  approvals.push({
    ...
    status: "pending",
    impact: { units: 0, percent: -0.017, skuCount: db.products.length, summary: "WAPE improves from 21.4% to 19.7% in the last 90-day backtest." },
    changeSet: [{ field: "Default model", from: "Gradient-boosted demand 2.4", to: "Gradient-boosted demand 2.5" }],
    evidence: ["Backtest BT-0412 (last 90 days).", "Candidate run today with model 2.5."],
  ...
  approvals.push({
    ...
    dueAt: iso(now - 2 * DAY_MS),
    status: "approved",
    impact: { units: -4210, percent: -0.07, skuCount: 14, summary: "Reduced baseline to match supplier allocation." },
    changeSet: [{ field: "Forecast (28 days)", from: "60,140 units", to: "55,930 units" }],
    evidence: ["Supplier allocation letter ALC-0917."],
  ...
  approvals.push({
    ...
    status: "rejected",
    impact: { units: -12_400, percent: -0.03, skuCount: 380, summary: "Would reduce East Java baseline." },
    changeSet: [{ field: "East Java demand", from: "0%", to: "−8%" }],
    evidence: ["Local news report."],
  ...
  db.notifications = [
    {
      ...
      title: "Approval requested: Beverages promotion uplift",
      body: "Rina Wijaya requested approval for an override of +6.0% on 124 SKUs.",
    ...
    },
    {
      ...
      title: "Promotions calendar sync failed",
      body: "Authentication failed (HTTP 401). Promotions are 4 days old.",
      ...
      ? [
          {
            ...
            title: "Daily refresh published",
            body: `${base.id} was published as today's planning baseline.`,
      ...
      : []),
    {
      ...
      title: "Blocking data issue: missing daily demand",
      body: "12 SKUs at 3 Sulawesi stores have no POS records for 6 days.",
    ...
    },
    {
      id: "ntf_7",
      category: "approval_completed",
      title: "Approved: Rice 5 kg supply allocation",
      body: "Yoga Pratama approved the override.",
    ...
    },
    {
      ...
      title: "Model 2.4 bias drifting upward",
      body: "Bias on Frozen rose to +6.1% over the last 14 days.",
...
function seedAudit(db: WorkspaceDb, now: number) {
  ...
  for (const run of db.runs) {
    ...
    if (run.publishedAt) {
      push({
        ...
        newState: "published",
        reason: "Validated against yesterday's actuals",
        source: "web",
      });
    }
  ...
  push({
    ...
    previousState: "20%",
    newState: "15%",
    reason: "Agreed in S&OP review to catch more material changes.",
    source: "web",
  });
  push({
  ...
  push({
    ...
    newState: "failed",
    reason: "HTTP 401 from promotions API",
    source: "system",
  });
