  ...
  db.notifications = [
    {
      ...
      title: "Ruang kerja dibuat: New Market Launch",
      body: "Selesaikan persiapan untuk memuat data permintaan dan menjalankan perkiraan pertama.",
      href: "/onboarding",
  ...
  db.sources = [
    {
      ...
      description: "Baris penjualan kasir yang digabung menjadi SKU × toko × hari.",
    },
    {
      id: "src_erp",
      ...
      description: "Pesanan grosir dan B2B dari ERP, dipakai untuk permintaan non-POS.",
    },
    {
      id: "src_dwh",
      ...
      description: "Master data produk dan toko, hierarki, dan atributnya.",
    },
    {
      id: "src_promo",
      ...
      description: "Promosi dan mekanisme yang direncanakan, dipakai sebagai fitur model.",
    },
    {
      id: "src_upload",
      ...
      description: "CSV manual berisi SKU baru dan produk pembandingnya.",
    },
  ];
}
...
function seedRuns(db: WorkspaceDb, now: number) {
  ...
  const candidate = makeRun(db, {
    id: runCode(t, 2),
    name: "Candidate model 2.5 · All categories",
    status: "completed",
    modelId: "mdl_gbm_25",
    modelVersion: "2.5",
    createdBy: "u_sari",
  ...
  db.dqIssues = [
    {
      ...
      severity: "blocking",
      sourceId: "src_pos",
      title: "Permintaan harian hilang untuk 12 SKU",
      description: "Tidak ada data POS untuk 12 SKU di 3 toko Sulawesi antara 9 sampai 3 hari lalu.",
      affectedSkus: 12,
      affectedLocations: 3,
    ...
    },
    {
      ...
      severity: "warning",
      sourceId: "src_promo",
      title: "Kalender promosi belum diperbarui 4 hari",
      description: "Sinkronisasi kalender promosi terakhir yang berhasil terjadi 4 hari lalu. Percobaan terbaru gagal dengan HTTP 401.",
    ...
    },
    {
      ...
      severity: "warning",
      sourceId: "src_erp",
      title: "Baris pesanan duplikat pada ekstrak ERP",
      description: "214 baris pesanan muncul dua kali di ekstrak ERP dengan nomor pesanan, SKU, dan jumlah yang sama.",
      affectedSkus: 57,
      affectedLocations: 6,
    ...
    },
    {
      ...
      severity: "warning",
      sourceId: "src_pos",
      title: "Permintaan nol tidak wajar untuk SKU volume tinggi",
      description: "9 SKU yang biasanya terjual lebih dari 200 unit sehari tercatat nol kemarin.",
      affectedSkus: 9,
      affectedLocations: 48,
      detectedAt: iso(now - 5 * HOUR_MS),
      status: "open",
      ownerId: null,
      forecastImpact: "If the zeros are genuine out-of-stocks, true demand is censored and the model will under-forecast.",
    ...
    },
    {
      ...
      severity: "info",
      sourceId: "src_pos",
      title: "Lonjakan penjualan ekstrem pada 3 SKU",
      description: "3 SKU terjual lebih dari 8× rata-rata 28 harinya dalam satu hari.",
      affectedSkus: 3,
      affectedLocations: 2,
    ...
    },
    {
      ...
      severity: "warning",
      sourceId: "src_erp",
      title: "Baris pesanan merujuk SKU yang tidak dikenal",
      description: "38 baris pesanan merujuk SKU yang tidak ada di master produk.",
      affectedSkus: 38,
      affectedLocations: 4,
    ...
    },
    {
      ...
      severity: "info",
      sourceId: "src_dwh",
      title: "Kolom baru pada dimensi toko",
      description: "Dimensi toko kini memuat kolom `store_format_v2` yang belum dipetakan.",
      affectedSkus: 0,
      affectedLocations: 0,
  ...
  db.overrides = [
    {
      ...
      evidence: "Surat alokasi pemasok, referensi ALC-0921.",
      comment: "Alokasi pemasok dikurangi selama 4 minggu.",
      userId: "u_arif",
      createdAt: iso(now - 3 * HOUR_MS),
      status: "applied",
      approvalId: null,
    },
    {
      ...
      evidence: "Ringkasan promosi dagang TPB-1142 (beli 2 gratis 1, minggu 1–2).",
      comment: "Promosi disepakati setelah kalender promosi berhenti tersinkron.",
      userId: "u_rina",
...
function seedApprovals(db: WorkspaceDb, now: number) {
  ...
  if (ovr) {
    approvals.push({
      ...
      impact: {
        ...
        summary: "Menaikkan acuan perencanaan untuk minuman yang dipromosikan selama 4 minggu ke depan.",
      },
      changeSet: [{ field: "Perkiraan (28 hari)", from: `${ovr.originalUnits.toLocaleString("id-ID")} unit`, to: `${ovr.newUnits.toLocaleString("id-ID")} unit` }],
  ...
  if (holiday && holiday.result) {
    approvals.push({
      ...
      impact: {
        ...
        skuCount: db.products.length,
        summary: "Memakai skenario ini menggantikan acuan untuk kategori terdampak pada rencana berikutnya.",
      },
  ...
  approvals.push({
    ...
    impact: {
      ...
      summary: "Menerbitkan mengirim jumlah yang direncanakan ke pengisian ulang untuk 4 minggu ke depan.",
    },
    changeSet: [{ field: "Status rencana", from: "Draf", to: "Diterbitkan" }],
  ...
  approvals.push({
    ...
    type: "model_default",
    objectId: "mdl_gbm_25",
    objectLabel: "Make Gradient-boosted demand 2.5 the default model",
    requestedBy: "u_sari",
    requestedAt: iso(now - 20 * HOUR_MS),
    dueAt: iso(now + 3 * DAY_MS),
    status: "pending",
    impact: { units: 0, percent: -0.017, skuCount: db.products.length, summary: "WAPE membaik dari 21,4% menjadi 19,7% pada uji model 90 hari terakhir." },
    changeSet: [{ field: "Model bawaan", from: "Gradient-boosted demand 2.4", to: "Gradient-boosted demand 2.5" }],
    evidence: ["Uji model BT-0412 (90 hari terakhir).", "Proses kandidat hari ini dengan model 2.5."],
    ...
    afterApproval: "New forecast runs use model 2.5 by default. Existing runs are unchanged.",
    history: [{ id: "apr_004-h1", at: iso(now - 20 * HOUR_MS), actorId: "u_sari", text: "Requested model promotion." }],
  });
  approvals.push({
    id: "apr_005",
    type: "override",
    ...
    dueAt: iso(now - 2 * DAY_MS),
    status: "approved",
    impact: { units: -4210, percent: -0.07, skuCount: 14, summary: "Acuan diturunkan agar sesuai alokasi pemasok." },
    changeSet: [{ field: "Perkiraan (28 hari)", from: "60.140 unit", to: "55.930 unit" }],
    evidence: ["Surat alokasi pemasok ALC-0917."],
  ...
  approvals.push({
    ...
    status: "rejected",
    impact: { units: -12_400, percent: -0.03, skuCount: 380, summary: "Akan menurunkan acuan Jawa Timur." },
    changeSet: [{ field: "Permintaan Jawa Timur", from: "0%", to: "−8%" }],
    evidence: ["Laporan berita lokal."],
  ...
  db.notifications = [
    {
      ...
      title: "Perlu persetujuan: kenaikan promosi Minuman",
      body: "Rina Wijaya mengajukan persetujuan perubahan +6,0% untuk 124 SKU.",
    ...
    },
    {
      ...
      title: "Sinkronisasi kalender promosi gagal",
      body: "Autentikasi gagal (HTTP 401). Data promosi berumur 4 hari.",
      ...
      ? [
          {
            ...
            title: "Penyegaran harian diterbitkan",
            body: `${base.id} diterbitkan sebagai acuan perencanaan hari ini.`,
      ...
      : []),
    {
      ...
      title: "Masalah data menghambat: permintaan harian hilang",
      body: "12 SKU di 3 toko Sulawesi tidak punya data POS selama 6 hari.",
    ...
    },
    {
      id: "ntf_7",
      category: "approval_completed",
      title: "Disetujui: alokasi pasokan Beras 5 kg",
      body: "Yoga Pratama menyetujui perubahan manual tersebut.",
    ...
    },
    {
      ...
      title: "Bias model 2.4 cenderung naik",
      body: "Bias pada kategori Beku naik ke +6,1% dalam 14 hari terakhir.",
...
function seedAudit(db: WorkspaceDb, now: number) {
  ...
  for (const run of db.runs) {
    ...
    if (run.publishedAt) {
      push({
        ...
        newState: "published",
        reason: "Sudah divalidasi dengan aktual kemarin",
        source: "web",
      });
    }
    if (run.status === "cancelled") {
      push({
        ...
        newState: "cancelled",
        reason: "Wilayah yang dipilih salah",
        source: "web",
      });
    }
  }
  ...
  push({
    ...
    previousState: "20%",
    newState: "15%",
    reason: "Disepakati dalam tinjauan S&OP agar lebih banyak perubahan penting terdeteksi.",
    source: "web",
  });
  push({
    ...
    newState: "suspended",
    reason: "Sudah tidak bekerja di organisasi ini.",
    source: "web",
  });
  push({
    ...
    newState: "failed",
    reason: "HTTP 401 dari API promosi",
    source: "system",
  });
