...
export const USERS: User[] = localized([
  { id: "u_rina", name: "Rina Wijaya", email: "rina.wijaya@mesta.click", title: pick("Perencana Permintaan", "Demand Planner"), role: "planner", workspaceIds: ALL, status: "active", lastActiveAt: null },
  { id: "u_dimas", name: "Dimas Santoso", email: "dimas.santoso@mesta.click", title: pick("Manajer Kategori, Minuman", "Category Manager, Beverages"), role: "manager", workspaceIds: ["ws_retail_prod", "ws_retail_stg", "ws_new_market"], status: "active", lastActiveAt: null },
  { id: "u_sari", name: "Sari Halim", email: "sari.halim@mesta.click", title: pick("Analis Perkiraan", "Forecast Analyst"), role: "analyst", workspaceIds: ALL, status: "active", lastActiveAt: null },
  ...
  { id: "u_arif", name: "Arif Nugroho", email: "arif.nugroho@mesta.click", title: pick("Perencana Pasokan", "Supply Planner"), role: "planner", workspaceIds: ["ws_retail_prod"], status: "active", lastActiveAt: null },
  { id: "u_lina", name: "Lina Kusuma", email: "lina.kusuma@mesta.click", title: pick("Insinyur Data", "Data Engineer"), role: "analyst", workspaceIds: ["ws_retail_prod", "ws_retail_stg"], status: "active", lastActiveAt: null },
  { id: "u_yoga", name: "Yoga Pratama", email: "yoga.pratama@mesta.click", title: pick("Manajer Kategori, Sembako", "Category Manager, Staples"), role: "manager", workspaceIds: ["ws_retail_prod"], status: "active", lastActiveAt: null },
  { id: "u_dewi", name: "Dewi Anggraini", email: "dewi.anggraini@mesta.click", title: pick("Perencana Permintaan", "Demand Planner"), role: "planner", workspaceIds: ["ws_retail_prod", "ws_conv_pilot"], status: "active", lastActiveAt: null },
  { id: "u_hendra", name: "Hendra Gunawan", email: "hendra.gunawan@mesta.click", title: pick("Perencana Operasional", "Operations Planner"), role: "planner", workspaceIds: ["ws_conv_pilot"], status: "active", lastActiveAt: null },
  ...
  { id: "u_eko", name: "Eko Saputra", email: "eko.saputra@mesta.click", title: pick("Perencana Permintaan (mantan)", "Demand Planner (former)"), role: "planner", workspaceIds: ["ws_retail_prod"], status: "suspended", lastActiveAt: null },
], [
